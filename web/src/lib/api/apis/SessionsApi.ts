...
export interface ForkSessionApiSessionsSessionIdForkPostRequest {
    sessionId: string;
...
export class SessionsApi extends runtime.BaseAPI {
    ...
    /**
     * Fork a session at a turn index.
     * Fork session
     */
    async forkSessionApiSessionsSessionIdForkPostRaw(requestParameters: ForkSessionApiSessionsSessionIdForkPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Session>> {
        if (requestParameters['sessionId'] == null) {
            throw new runtime.RequiredError(
                'sessionId',
                'Required parameter "sessionId" was null or undefined when calling forkSessionApiSessionsSessionIdForkPost().'
            );
        }
     ...
     * Fork session
     */
    async forkSessionApiSessionsSessionIdForkPost(requestParameters: ForkSessionApiSessionsSessionIdForkPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Session> {
        const response = await this.forkSessionApiSessionsSessionIdForkPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
