...
func init() {
	...
	os.Unsetenv("MOCODE_GLOBAL_CONFIG")
	os.Unsetenv("MOCODE_GLOBAL_DATA")
}
...
func TestDirs(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakeconfig/mocode") + "\n" +
		filepath.FromSlash("/tmp/fakedata/mocode") + "\n"
...
func TestDataDir(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakedata/mocode") + "\n"
	require.Equal(t, expected, b.String())
}
