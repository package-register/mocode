...
// Backend provides transport-agnostic business logic for the Mocode
...
func (b *Backend) CreateWorkspace(args proto.Workspace) (*Workspace, proto.Workspace, error) {
	...
	if err := createDotMocodeDir(cfg.Config().Options.DataDirectory); err != nil {
		return nil, proto.Workspace{}, fmt.Errorf("failed to create data directory: %w", err)
	}

	appWorkspace, err := app.New(b.ctx, cfg)
	if err != nil {
